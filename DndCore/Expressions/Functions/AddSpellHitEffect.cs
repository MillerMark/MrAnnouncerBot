...
namespace DndCore
{
	...
	[Param(2, typeof(int), "hue", "The hue of the effect.", ParameterIs.Optional)]
	...
	[Param(9, typeof(int), "secondaryHue", "The secondary hue for effects that have two components (like fireball).", ParameterIs.Optional)]
	[Param(10, typeof(int), "secondarySaturation", "The secondary saturation for effects that have two components (like fireball).", ParameterIs.Optional)]
	[Param(11, typeof(int), "secondaryBrightness", "The secondary brightness for effects that have two components (like fireball).", ParameterIs.Optional)]
