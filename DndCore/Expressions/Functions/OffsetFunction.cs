...
namespace DndCore
{
	...
	[Param(1, typeof(string), "variableName", "The variable to modify.", ParameterIs.Required)]
	[Param(2, typeof(double), "deltaValue", "The delta amount to change.", ParameterIs.Required)]
