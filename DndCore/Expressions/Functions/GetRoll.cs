...
namespace DndCore
{
	...
	[Param(1, typeof(string), "rollName", "The saved name of the roll to check. For example, RollDice(\"1d8(superiority:BarbarianWildSurge)\") will roll the dice and save the result of the roll with the name \"BarbarianWildSurge\".")]
