...
namespace OverlayManager.Hubs
{
	...
	{
		Task ExecuteCommand(string command, string args, string userId, string userName, string displayName, string color, string profileImageUrl, int showsWatched);
		Task ControlSpaceship(string command, string data, string userId, string userName, string displayName, string color, string profileImageUrl, int showsWatched);
