...
namespace DHDM
{
	public static class CardCommands
	{
		...
		{
			if (command.StartsWith(CMD_RollDie))
		...
		private static void AddDieStr(DiceRoll diceRoll, CardDto cardDto, DndViewer viewer, string dieStr, string dieLabelOverride = null)
		{
