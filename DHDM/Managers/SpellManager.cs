...
namespace DHDM
{
	public static class SpellManager
	{
	  ...
	  */
		...
		static void PlayEffect(string effectName, string spellId, string taleSpireId, float lifeTime, EffectLocation effectLocation, float secondsDelayStart, float enlargeTime, float shrinkTime, float rotationDegrees, float wallLength, float distanceBetweenWallEffectsFeet)
		{
		...
		{
			PlayEffect(ea.EffectName, ea.SpellId, ea.TaleSpireId, ea.LifeTime, ea.EffectLocation, ea.SecondsDelayStart, ea.EnlargeTime, ea.ShrinkTime, ea.RotationDegrees, ea.WallLength, ea.DistanceBetweenWallEffectsFeet);
		}
